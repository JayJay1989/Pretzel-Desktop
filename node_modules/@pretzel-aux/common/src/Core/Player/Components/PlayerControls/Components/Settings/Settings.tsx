...
import { OptionIcon, OptionsWrapper, OptionWrapper } from './Styles';
    ...
    return (
      <OptionsWrapper>
        ...
        <StationOption
          ...
          active={this.props.pretzelUser.premium ? this.props.notifyInChat : true}
          onClick={this.handleToggleNotify}
        />
        {!this.props.pretzelUser.premium && (
          <StationOption icon="radio" title="Non Interactive Mode" active={true} onClick={this.handleClickPremium} />
        )}
      </OptionsWrapper>
    );
  }
...
const StationOption = ({
  ...
  <div title={title}>
    <OptionWrapper disabled={disabled} onClick={onClick}>
