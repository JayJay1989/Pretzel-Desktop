...
import { PlatformContext } from 'common/src/Core/Platform';
  ...
  public render() {
    return (
      <SettingsSection title="What's Playing">
        <CheckboxOption
          label="Announce what's playing in chat"
          disabled={true}
...
export const WhatsPlaying = compose(withSettingsContext(mapContextToProps))(WhatsPlayingPresentation);
