  ...
  public render() {
    ...
    const text = (
      <>
        ...
        <Text size="xsmall">{album.name}</Text>
        <Box flex="grow" justify="end">
          <Text size="10px" color={Night.textMuted} margin={{ top: '16px' }} align-self="end">
            {album.stats.totalCount} Songs&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;{minutesOrHours(album.stats.duration)}
          </Text>
        </Box>
      </>
    );
...
export const AlbumCard = compose(withPlayerContext(mapContextToProps))(AlbumCardPresentation);
